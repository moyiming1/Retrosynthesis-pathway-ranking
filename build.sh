...
torch-model-archiver \
  --model-name pathway-ranker \
  --version 1.0 \
  --model-file tree_lstm/model.py \
  --serialized-file trained_model/treeLSTM512-fp2048.pt \
  --handler tree_lstm/handler.py \
  --extra-files features/tree_to_treeLSTM_input.py
